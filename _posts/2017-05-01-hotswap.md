...
<span class="image main"><img src="{{ site.url }}{{ site.baseurl }}/images/projects/hotswap/main1.jpg" alt="" /></span>
...
<span class="image right"><img src="{{ site.url }}{{ site.baseurl }}/images/projects/hotswap/batt.png" alt="" /></span>The main challenge here was finding the right balance between simplicity (minimal motors) and the security of the locking mechanism during flight. We solved this with an interference joint on our battery case to lock it perfectly in place.
...
<span class="image main"><img src="{{ site.url }}{{ site.baseurl }}/images/projects/hotswap/linear_slider.png" alt="" /></span>
...
<span class="image main"><img src="{{ site.url }}{{ site.baseurl }}/images/projects/hotswap/jacobs.jpg" alt="" /></span>

<span class="image main"><img src="{{ site.url }}{{ site.baseurl }}/images/projects/hotswap/poster.png" alt="" /></span>
...
<span class="image main"><img src="{{ site.url }}{{ site.baseurl }}/images/projects/hotswap/team.jpg" alt="" /></span>
